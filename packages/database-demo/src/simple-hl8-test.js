...
async function testHl8DatabaseSource() {
  ...
  try {
    ...
    const connectionManager = await import(
      "/home/arligle/hl8/hl8-ai-saas-platform/libs/database/src/connection/connection.manager.js"
    );
    console.log("✅ ConnectionManager 源码导入成功");

    const healthCheckService = await import(
      "/home/arligle/hl8/hl8-ai-saas-platform/libs/database/src/monitoring/health-check.service.js"
    );
    console.log("✅ HealthCheckService 源码导入成功");

    const transactionService = await import(
      "/home/arligle/hl8/hl8-ai-saas-platform/libs/database/src/transaction/transaction.service.js"
    );
    console.log("✅ TransactionService 源码导入成功");

    const entityMapper = await import(
      "/home/arligle/hl8/hl8-ai-saas-platform/libs/database/src/mapping/entity-mapper.js"
    );
    console.log("✅ EntityMapper 源码导入成功");

    const metricsService = await import(
      "/home/arligle/hl8/hl8-ai-saas-platform/libs/database/src/monitoring/metrics.service.js"
    );
...
export {
  runSimpleHl8Tests,
  testHl8DatabaseSource,
  testHl8DatabaseStructure,
  testHl8DatabaseConfig,
  testHl8DatabaseFeatures,
};
