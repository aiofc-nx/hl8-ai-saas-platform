...
class BatchCacheService {
  ...
  async getMultiple(keys: string[]) {
    const promises = keys.map(key => 
      this.cacheService.get('data', key)
    );
