...
export declare class DomainExceptionFactory {
    static createBusinessRuleViolation(ruleCode: string, message: string, context?: Record<string, unknown>): DomainBusinessRuleViolationException;
    static createValidation(field: string, message: string, context?: Record<string, unknown>): DomainValidationException;
    static createTenantIsolation(message: string, code: string, context?: Record<string, unknown>): DomainTenantIsolationException;
}
