...
export interface ExceptionModuleAsyncOptions extends Pick<ModuleMetadata, "imports"> {
    useFactory?: (...args: unknown[]) => Promise<ExceptionModuleOptions> | ExceptionModuleOptions;
...
export interface ExceptionOptionsFactory {
    createExceptionOptions(): Promise<ExceptionModuleOptions> | ExceptionModuleOptions;
}
