...
describe('ResponseFormatter', () => {
  ...
  describe('error', () => {
    it('should format error response with code and message', () => {
      const result = ResponseFormatter.error('VALIDATION_ERROR', 'Invalid input');
    ...
    it('should format error response with details', () => {
      ...
      const result = ResponseFormatter.error('VALIDATION_ERROR', 'Invalid input', details);
    ...
    it('should format error response with custom meta', () => {
      ...
      const result = ResponseFormatter.error('ERROR', 'Test error', undefined, customMeta);
  ...
  describe('authenticationError', () => {
    ...
    it('should format authentication error with custom meta', () => {
      ...
      const result = ResponseFormatter.authenticationError('Custom auth error', customMeta);
  ...
  describe('edge cases', () => {
    ...
    it('should handle large data gracefully', () => {
      const largeData = Array(1000).fill(null).map((_, i) => ({ id: i, data: 'test' }));
