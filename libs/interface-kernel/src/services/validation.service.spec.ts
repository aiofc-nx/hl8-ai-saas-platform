...
describe("ValidationService", () => {
  ...
  describe("validateRequestData", () => {
    it("should validate request data with valid schema", async () => {
      ...
      const result = await service.validateRequestData(
        mockRequest,
        "userCreate",
      );
  ...
  describe("validateQueryParams", () => {
    ...
    it("should validate required query parameters", async () => {
      ...
      const result = await service.validateQueryParams(
        requestWithoutRequired,
        requiredRules,
      );
  ...
  describe("validatePathParams", () => {
    ...
    it("should validate required path parameters", async () => {
      ...
      const result = await service.validatePathParams(
        requestWithoutRequired,
        rules,
      );
  ...
  describe("validateRequestBody", () => {
    ...
    it("should validate required fields", async () => {
      ...
      const result = await service.validateRequestBody(
        requestWithoutRequired,
        rules,
      );
  ...
  describe("field type validation", () => {
    it("should validate string type", () => {
      ...
      expect(service["validateFieldType"](123, rule)).toContain(
        "must be a string",
      );
    });
    ...
    it("should validate number type", () => {
      ...
      expect(service["validateFieldType"]("123", rule)).toBeNull();
      expect(service["validateFieldType"]("abc", rule)).toContain(
        "must be a number",
      );
    });
    ...
    it("should validate boolean type", () => {
      ...
      expect(service["validateFieldType"]("true", rule)).toBeNull();
      expect(service["validateFieldType"]("false", rule)).toBeNull();
      expect(service["validateFieldType"]("yes", rule)).toContain(
        "must be a boolean",
      );
    });
    ...
    it("should validate email type", () => {
      ...
      expect(service["validateFieldType"]("invalid-email", rule)).toContain(
    ...
    it("should validate uuid type", () => {
      ...
      expect(
        service["validateFieldType"](
          "123e4567-e89b-12d3-a456-426614174000",
          rule,
        ),
      ).toBeNull();
      expect(service["validateFieldType"]("invalid-uuid", rule)).toContain(
    ...
    it("should validate date type", () => {
      ...
      expect(service["validateFieldType"]("invalid-date", rule)).toContain(
    ...
    it("should validate array type", () => {
      ...
      expect(service["validateFieldType"]("not-array", rule)).toContain(
        "must be an array",
      );
    });
    ...
    it("should validate object type", () => {
      ...
      expect(service["validateFieldType"]([], rule)).toContain(
        "must be an object",
      );
    });
  });
  ...
  describe("field value validation", () => {
    it("should validate minimum values", () => {
      ...
      expect(service["validateFieldValue"]("hi", rule)).toContain(
    ...
    it("should validate maximum values", () => {
      ...
      expect(service["validateFieldValue"]("hello", rule)).toBeNull();
      expect(service["validateFieldValue"]("hello world", rule)).toContain(
    ...
    it("should validate patterns", () => {
      ...
      expect(service["validateFieldValue"]("hello", rule)).toBeNull();
      expect(service["validateFieldValue"]("Hello123", rule)).toContain(
        "format is invalid",
      );
    });
    ...
    it("should validate custom rules", () => {
      ...
      expect(service["validateFieldValue"]("invalid", rule)).toContain(
