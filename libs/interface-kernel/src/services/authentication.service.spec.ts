...
import { AuthenticationService, JwtAuthStrategy } from './authentication.service';
...
describe('AuthenticationService', () => {
  ...
  describe('generateToken', () => {
    ...
    it('should handle token generation errors', async () => {
      ...
      await expect(service.generateToken(invalidUser))
  ...
  describe('verifyToken', () => {
    ...
    it('should throw error for malformed token', async () => {
      ...
      await expect(service.verifyToken(malformedToken))
        .rejects.toThrow('Invalid token');
    });
  });
  ...
  describe('refreshToken', () => {
    ...
    it('should handle refresh errors', async () => {
      ...
      await expect(service.refreshToken(invalidUser))
...
describe('JwtAuthStrategy', () => {
  ...
  describe('validate', () => {
    ...
    it('should throw error for invalid issuer', async () => {
      ...
      await expect(strategy.validate(invalidIssuerPayload))
    ...
    it('should throw error for invalid audience', async () => {
      ...
      await expect(strategy.validate(invalidAudiencePayload))
