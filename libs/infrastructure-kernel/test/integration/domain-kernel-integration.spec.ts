 ...
 * 领域层集成服务单元测试
 *
 * @description 测试 DomainKernelIntegrationService 的集成功能
 * @since 1.0.0
 */

import { Test, TestingModule } from "@nestjs/testing";
import { DomainKernelIntegrationService } from "../../src/integration/domain-kernel-integration.js";

describe("DomainKernelIntegrationService", () => {
  let service: DomainKernelIntegrationService;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        DomainKernelIntegrationService,
        {
    ...
    service = module.get<DomainKernelIntegrationService>(
      DomainKernelIntegrationService,
    );
  });
  ...
  describe("integrate", () => {
    it("should integrate with domain kernel", async () => {
      // Arrange
      const config = {
        enabled: true,
  ...
  describe("disconnect", () => {
    it("should disconnect from domain kernel", async () => {
      // Act
  ...
  describe("reconnect", () => {
    it("should reconnect to domain kernel", async () => {
      // Arrange
      mockConnectionManager.getConnection.mockResolvedValue({
        name: "default",
        isConnected: true,
